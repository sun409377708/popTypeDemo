...
#define kIphoneXBottom (IS_IPhoneX_TYPE ? 25 : 5)
    ...
    switch (type) {
        ...
        case 5: // bottomFade
            return CGPointMake(_maskView.center.x,
                               _maskView.bounds.size.height - _popupView.bounds.size.height / 2 - 10);
        default: // center
...
- (CGPoint)prepareCenter {
    ...
    if (_layoutType == zhPopupLayoutTypeBottomFade) {
        CGPoint point = CGPointMake(_maskView.center.x,
                                    _maskView.bounds.size.height - _popupView.bounds.size.height / 2 - 10);
        if (_slideStyle == zhPopupSlideStyleShrinkInOut1) {
            _popupView.transform = CGAffineTransformMakeScale(0.15, 0.15);
        } else if (_slideStyle == zhPopupSlideStyleShrinkInOut2) {
...
- (CGPoint)finishedCenter {
    ...
    switch (_layoutType) {
        ...
        case zhPopupLayoutTypeBottom:
            return CGPointMake(point.x,
                               _maskView.bounds.size.height - _popupView.bounds.size.height / 2 -  kIphoneXBottom);
        case zhPopupLayoutTypeHaveButtonBottom:
            return CGPointMake(point.x,
                               _maskView.bounds.size.height - _popupView.bounds.size.height / 2 -  25);
        ...
        case zhPopupLayoutTypeRight:
            return CGPointMake(_maskView.bounds.size.width - _popupView.bounds.size.width / 2,
                               point.y);
        case zhPopupLayoutTypeBottomFade:
        {
            if (_slideStyle == zhPopupSlideStyleShrinkInOut1 ||
