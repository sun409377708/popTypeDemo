...
typedef NS_ENUM(NSUInteger, zhPopupLayoutType) {
    ...
    zhPopupLayoutTypeHaveButtonBottom,
    zhPopupLayoutTypeLeft,
    zhPopupLayoutTypeRight,
    zhPopupLayoutTypeBottomFade,
...
+ (instancetype _Nullable )popupControllerWithMaskType:(zhPopupMaskType)maskType;

/// The `popupView` is the parent view of your custom contentView
@property (nonatomic, strong, readonly) UIView * _Nullable popupView;
